...
export default function Search({
    ...
    return (
        ...
        >
            <span
                className={`[&>svg]:size-6 size-6 lg:[&>svg]:size-5 block [&>svg]:right-2 [&>svg]:top-1/2 [&>svg]:fill-stone-800 dark:[&>svg]:fill-stone-100 md:[&>svg]:absolute md:[&>svg]:-translate-y-1/2 ${
            ...
            <input
                ...
                className={`${inputClassNames} bg-main shadow-main rounded-lg px-1 py-2 pr-2 text-xs caret-primary-500 placeholder:text-xs focus:outline-none lg:pr-3 ${
